...
//  WordGarden
//
//  Created by Jim Walejko on 12/10/25.
//

import SwiftUI

struct ContentView: View {
    private static let maxiumumGuesses = 8  //Need to refer to this a Self.maximumGuesses
    ...
    @State private var guessesRemaining = maxiumumGuesses
            ...
            if playAgainHidden{
                HStack{
                    TextField("", text: $guessedLetter)
                        ...
                        .onSubmit {
                            // As long as guessedLetter is not an empty String we continue, otherwise don't do anything
                ...
                Button(playAgainButtonLabel){
                    ...
                    lettersGuessed = ""
                    guessesRemaining = Self.maxiumumGuesses // because maximumGuesses is static
